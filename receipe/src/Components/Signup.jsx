...
function Signup(){
  ...
  <form action="" class="form_main">
    ...
    <svg fill="none" viewBox="0 0 24 24" height="16" width="16" xmlns="http://www.w3.org/2000/svg" class="inputIcon">
    ...
    <div class="inputContainer">
    <svg class="inputIcon" xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#2e2e2e" viewBox="0 0 16 16">
...
<button id="button">Submit</button>
    <a class="forgotLink" href="/login">Already have an account?</a>
</form>
